...
static const uint8_t blue = 0x12, yellow = 0x60, yellowT = 0x16, main0 = 0x17, blue_fill = 0x11, clearP = 0xC0; // 0x13 = 蓝 0x14 = 红 0x15 = 粉红色
...
//*************************************过时的方法 ( 颜色+符号 )*********************************************//
void OSD_c1(volatile int  test, volatile int  test1, volatile int  colour) {
  OSD_parameters(test1, 0x00, test);
  OSD_parameters(test1 - 1, 0x00, colour);
}
void OSD_c2(volatile int  test, volatile int  test1, volatile int  colour) {
  OSD_parameters(test1, 0x02, test);
  OSD_parameters(test1 - 1, 0x02, colour);
}
void OSD_c3(volatile int  test, volatile int  test1, volatile int  colour) {
  OSD_parameters(test1, 0x03, test);
  OSD_parameters(test1 - 1, 0x03, colour);
}

//***************************************颜色+符号+轮廓*********************************************//
void __( volatile int symbol, volatile int number) {
...
//***************************************资料名称*********************************************//
void nameP() {
  __(x1, _15); __(x2, _16); __(x3, _17); __(x4, _18); __(x5, _19); __(x6, _20); __(x7, _21); __(x8, _22); __(x9, _23);
}
...
void clean_up(char stroca, char str, char str1) { // очистка строки (+2)  
  number_stroca = stroca;// номер строки  OSD
  for (byte addressT1 = str1; addressT1 < str; ++addressT1) {
    switch (addressT1) {
      case 1: colour1 = blue_fill; __(o, _0); break; case 2: colour1 = blue_fill; __(o, _1); break; case 3: colour1 = blue_fill; __(o, _2); break; case 4: colour1 = blue_fill; __(o, _3); break; case 5: colour1 = blue_fill; __(o, _4); break;
      case 6: colour1 = blue_fill; __(o, _5); break; case 7: colour1 = blue_fill; __(o, _6); break; case 8: colour1 = blue_fill; __(o, _7); break; case 9: colour1 = blue_fill; __(o, _8); break; case 10: colour1 = blue_fill; __(o, _9); break;
      case 11: colour1 = blue_fill; __(o, _10); break; case 12: colour1 = blue_fill; __(o, _11); break; case 13: colour1 = blue_fill; __(o, _12); break; case 14: colour1 = blue_fill; __(o, _13); break; case 15: colour1 = blue_fill; __(o, _14); break;
      case 16: colour1 = blue_fill; __(o, _15); break; case 17: colour1 = blue_fill; __(o, _16); break; case 18: colour1 = blue_fill; __(o, _17); break; case 19: colour1 = blue_fill; __(o, _18); break; case 20: colour1 = blue_fill; __(o, _19); break;
      case 21: colour1 = blue_fill; __(o, _20); break; case 22: colour1 = blue_fill; __(o, _21); break; case 23: colour1 = blue_fill; __(o, _22); break; case 24: colour1 = blue_fill; __(o, _23); break; case 25: colour1 = blue_fill; __(o, _24); break;
      case 26: colour1 = blue_fill; __(o, _25); break; case 27: colour1 = blue_fill; __(o, _26); break; case 28: colour1 = blue_fill; __(o, _27); break;
...
//**************************************Background********************************************//
void background_up(char  stroca, char str, char colour_) {
...
//*************************************************************************************//
void Type4 (byte  addr) { //inversion 255-0
  switch (addr) {
    case 0x00:
      OSD_c1(n5, P21, main0);
      OSD_c1(n5, P20, main0);
